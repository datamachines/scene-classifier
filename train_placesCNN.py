'''
This code is modified from https://github.com/CSAILVision/places365 (author: Bolei Zhou) and the pytorch example code: https://github.com/pytorch/examples/blob/master/imagenet/main.py
...
parser = argparse.ArgumentParser(description='PyTorch Scene Classifier')
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        #input_var = torch.autograd.Variable(input) #Variable is depricated
...
def adjust_learning_rate(optimizer, epoch):
    ...
    '''Sets the learning rate to the initial LR decayed by 20 every 5 epochs'''
    lr = args.lr * (0.2 ** (epoch // 5))
